...
import { Bot, Save, Share2, Settings, Github } from "lucide-react"
  ...
  return (
    <header className="h-14 border-b border-border bg-card flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="p-2 hover:bg-secondary rounded text-muted-foreground transition"><Github className="h-5 w-5" /></button>
        <button className="p-2 hover:bg-secondary rounded text-muted-foreground transition"><Settings className="h-5 w-5" /></button>
